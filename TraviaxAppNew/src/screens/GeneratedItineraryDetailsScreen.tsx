...
interface GeneratedItineraryDetailsScreenProps {
  navigation: {
...
const DEFAULT_LOCATION = 'Your Destination';
const DEFAULT_TITLE = 'Your Trip';
const DEFAULT_DATES = 'Trip Dates';

const GeneratedItineraryDetailsScreen: React.FC<
  GeneratedItineraryDetailsScreenProps
> = ({navigation, route}) => {
  ...
  const handleSaveItinerary = () => {
    console.log('Save Generated Itinerary');
...
export default GeneratedItineraryDetailsScreen;
